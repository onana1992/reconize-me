...
const PATHS: Record<IconName, string> = {
  ...
  activity: "M8 14A6 6 0 1 0 8 2a6 6 0 0 0 0 12ZM8 4.4V8l2.6 1.6",
  billing: "M2.4 4.2h11.2A1.2 1.2 0 0 1 14.8 5.4v6.2a1.2 1.2 0 0 1-1.2 1.2H2.4A1.2 1.2 0 0 1 1.2 11.6V5.4A1.2 1.2 0 0 1 2.4 4.2ZM1.2 7.2h13.6M4 10.2h3.2",
